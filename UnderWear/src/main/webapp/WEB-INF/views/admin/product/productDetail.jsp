	        ...
	        var butChk = 0;		// 수정버튼과 삭제버튼을 구별하기 위한 변수(전역변수)
	     	$(function() { 	     		
	     		...
	     		$("#productDeleteBtn").click(function() {
	     			$("#f_data").attr("action","/admin/product/productDelete.do");
	     			$("#f_data").submit();
	     		});
	     	})
					...
					<div class="contentTB">
						<table>
							<tbody>
								...
								<tr>
									<td class="ac">대분류</td>
									<td colspan="2">${detail.bigct_category}</td>
								</tr>
								<tr>
									<td class="ac">소분류</td>
									<td colspan="2">${detail.smallct_category}</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="2">${detail.p_inventory}</td>
								</tr>
								<tr>
									<td class="ac vm">상품 가격</td>
									<td colspan="2">${detail.pr_01}</td>
								</tr>
								<tr>
									<td class="ac vm">상품 컬러</td>
									<td colspan="2">${detail.p_color}</td>
								</tr>
								<tr>
									<td class="ac vm">상품 사이즈</td>
									<td colspan="2">${detail.p_size}</td>
								</tr>
								<tr>
									<td class="ac vm">상품 성별</td>
									<td colspan="2">${detail.p_gender}</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="2">${detail.p_content}</td>
								</tr>
								...
								<c:if test="${not empty imageList}">
									<c:forEach var="image" items="${imageList}" varStatus="status">
										<tr>
											...
											<td colspan="2"><img src="/uploadStorage/product/${image.img_image}" data-no="${image.img_no}"></td>
										</tr>
									</c:forEach>
								</c:if>
							</tbody>
