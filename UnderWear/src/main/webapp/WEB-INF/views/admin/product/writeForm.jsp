			  ...
			  /*이미지 추가 버튼 클릭시 처리 이벤트 */
	           $("#fileBtn").click(function(){
				 ...
				 var br = $("<br/>");
	              ...
	              $("#boardWrite tr:nth-child(11) td:eq(0)").attr("rowspan", fileIndex+1)
	              $("#boardWrite tr:nth-child(11) td:eq(1)").append("<input type='file' name='files["+ fileIndex + "]' class='gapBox' />");
